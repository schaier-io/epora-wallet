  ...
  return (
      <div className="space-y-4">
        {!walletReady ? (
          ...
          >
            <div className="flex h-14 w-14 items-center justify-center rounded-lg border border-border/60 bg-background/70">
          ...
          <>
            ...
            {detectedSttTokensError ? (
              <FadeContent
                role="alert"
                className="rounded-lg border border-rose-500/30 bg-rose-500/10 p-3 text-sm text-rose-100 [overflow-wrap:anywhere]"
              >
                {detectedSttTokensError}
              </FadeContent>
            ) : null}
