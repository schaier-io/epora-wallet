// Workspace-wide constants. Larger static catalogs live in their own files:
// guided-admin-catalog.ts (admin task groups/tasks) and
// stt-spend-action-tabs.ts (per-mode spend surface copy).
