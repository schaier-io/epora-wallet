...
export function SparkleEasterEgg({ open, onOpenChange }: SparkleEasterEggProps) {
  ...
  const renderResponse = (entry: LogEntry) => {
    ...
    switch (entry.kind) {
      ...
      case "ls":
        ...
        return (
          <div className="flex flex-wrap gap-x-5 gap-y-0.5">
            <span className="text-emerald-100/50">recovery.log</span>
            <span className="text-emerald-100/50">notes.txt</span>
      ...
      case "denied":
        return <div className="text-emerald-100/50">{firstRaw}{i18n("permissionDenied")}</div>;
      default:
        return <div className="text-emerald-100/50">{i18n("commandNotFound")} {firstRaw}</div>;
    }
  };
