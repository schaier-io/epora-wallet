...
const TX_PATHS: Array<[string, string, string, string, z.ZodType]> = [
  ...
  [
    ...
    "Run one of the eleven State transitions: `use`, `renew-proof-of-life`, `update-state`, `manage-streaming-payments`, `use-allowance`, `use-beneficiary`, `stop-beneficiary-stream`, `distribute-beneficiaries`, `payout-streaming-payment`, `cancel-streaming-payment` and `remove-access-index`. `action` selects which.",
