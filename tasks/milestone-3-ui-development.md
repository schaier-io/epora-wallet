...
- [ ] **Public, versioned API + spec for outside developers**: Catalyst acceptance criterion 2. The published surface has v1 reads and nine active transaction-build routes. The external guide review and transaction confirmation remain open. [Decisions and their rationale](subtasks/m3-api-00-decisions.md).
  ...
  - [ ] [Developer docs: curl examples and the versioning policy](subtasks/m3-api-06-dev-docs.md) — written and verified against a live deployment; the outside-reader pass still needs a person
