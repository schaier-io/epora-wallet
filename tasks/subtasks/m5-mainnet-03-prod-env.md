...
- [x] Mainnet app boots and indexes at its own domain. See [live deployment checks on 2026-09-26](../milestone-5-mainnet-closeout.md#live-deployment-check-2026-09-26).
...
- [x] Confirm Preprod remains online. Its health endpoint returned HTTP 200 with database and indexer up on 2026-09-26. This does not prove every flow is unchanged.
