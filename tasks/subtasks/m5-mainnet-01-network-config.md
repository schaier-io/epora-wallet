...
2026-09-26: network configuration is implemented on `main` at `d3b5a239`.
...
- [x] Document the network variables. `main` at `d3b5a239`, `code/dApp/.env.example:1-9`, contains the build-time network, separate-mainnet-deployment note, and mainnet provider key.
