...
- [x] `/api/health` reports cursor freshness and database reachability. Mainnet and Preprod returned HTTP 200 with database/indexer up in the [2026-09-26 check](../milestone-5-mainnet-closeout.md#live-deployment-check-2026-09-26). Source: `main` at `d3b5a239`, `code/dApp/src/app/api/health/route.ts`, `GET`.
