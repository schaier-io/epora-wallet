...
- [x] Document rebuild, blueprint sync, new wallet hashes, reference deployment, and verification. `docs/RUNBOOK.md:209-220` contains these steps.
- [x] Document that existing wallets retain their old validators. `docs/RUNBOOK.md:213-215` states this distinction.
