...
`docs/testnet-feedback.md:149-150` records the public app and a successful database health probe on 2026-09-22.

## Completed

- [x] Select Vercel and document deployment configuration. `docs/RUNBOOK.md:89-137` describes environment configuration and the Vercel cron.
- [x] Refuse the development authentication secret in production. `code/dApp/src/lib/env/server-env.ts:87-118` rejects missing, short, and known weak secrets. Existing tests cover these cases in `server-env.test.ts:58-77`.
