...
Correction, 2026-09-26: the earlier description assumed both connection paths already provided signers. `submit.ts:12` still accepts `BrowserWallet`. The second signer is future work.
...
- The pre-sign review shows which signer will be asked. Users with an extension and a paired phone can then identify the signing device.
